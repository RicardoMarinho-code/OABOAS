...
export const RightBar = () => {
  ...
  return (
    <>
      <aside className="sticky top-6 hidden w-96 flex-col gap-6 self-start sm:flex">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <h2 className="text-xl font-bold text-black">Pontos</h2>
                <p className="text-sm font-normal text-gray-400">
                  Você tem {lingots} {lingots === 1 ? "ponto" : "pontos"}.
                </p>
                <Link
    ...
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      ...
      <div className="flex items-center gap-6">
        ...
        <p className="text-sm leading-6 text-gray-500">
          Complete mais {lessonsNeededToUnlockLeaderboards} 
          {lessonsNeededToUnlockLeaderboards === 1 ? "" : " simulados"} 
          para começar a competir
        </p>
      </div>
    </article>
  );
...
const XpProgressSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <div className="flex items-center justify-between">
        <h2 className="text-xl">Progresso Semanal</h2>
      ...
      <div className="flex gap-5">
        ...
        <div className="flex grow flex-col justify-around">
          <h3 className="font-normal text-gray-500">Meta Semanal</h3>
          <div className="flex items-center gap-5">
            <div className="relative h-4 w-full grow rounded-full bg-gray-200">
              {xpToday > 0 && (
                <div
                  ...
                  style={{ width: `${Math.min(1, xpToday / goalXp) * 100}%` }} // Mantido como XP por enquanto
                >
            ...
            <div className="text-md shrink-0 font-normal text-gray-400">
              {xpToday}/{goalXp} XP {/* Mantido como XP por enquanto */}
            </div>
          </div>
        </div>
      </div>
...
const CreateAProfileSection = ({
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold">
      ...
      <button
        className="rounded-2xl border-b-4 border-oab-blue-dark bg-oab-blue py-3 uppercase text-white transition hover:brightness-110"
